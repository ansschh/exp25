...
\hline
\input{PHASE1_real_wavelength_files/PHASE10_global_physics_constrained_fit/tables/global_physics_constrained_table_body.tex}
\hline
\end{tabular}
\end{table}
...
Quantity & Value \\
\hline
\input{PHASE1_real_wavelength_files/PHASE10B_global_profile_uncertainty/tables/global_profile_uncertainty_table_body.tex}
\hline
\end{tabular}
\end{table}
