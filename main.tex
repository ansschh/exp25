...
\hline
\input{PHASE1_real_wavelength_files/PHASE3_instrument_resolution/instrument_resolution_table_body.tex}
\hline
\end{tabular}
\end{table}
...
\hline
\input{PHASE1_real_wavelength_files/PHASE4_Hydrogen_only_control/tables_for_latex/hydrogen_only_fit_table_body.tex}
\hline
\end{tabular}
\end{table}
...
\hline
\input{PHASE1_real_wavelength_files/PHASE4_Hydrogen_only_two_gaussian_checks/tables/H_epsilon_zeta_two_gaussian_table_body.tex}
\hline
\end{tabular}
\end{table}
...
\hline
\input{PHASE1_real_wavelength_files/PHASE5C_actual_HD_fast_bounded_refit/tables_for_latex/fast_bounded_actual_HD_fit_table_body.tex}
\hline
\end{tabular}
\end{table}
...
\hline
\input{PHASE1_real_wavelength_files/PHASE5D_H_alpha_local_refit/H_alpha_local_refit_table_body.tex}
\hline
\end{tabular}
\end{table}
